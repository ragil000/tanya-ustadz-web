                ...
                <div class="all-posts-area">
                    ...
                    <?php
                        ...
                        foreach($dataReady['data'] as $dataReadyRead){
                            $id_tb_penjawab = $dataReadyRead['id_tb_penjawab'];
                    ...
                    <div class="single-post-area mb-30" id="form-answer-section">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-12">
                                <form action="<?=base_url()?>editor/post-published-answer" method="POST" enctype="multipart/form-data" name="form-publish" onsubmit="return validateForm()">
                                    ...
                                    <input type="text" name="tb_pertanyaan_isi" value="<?=$tb_pertanyaan_isi?>" hidden>
                                    <input type="text" name="id_tb_jawaban" value="<?=$id_tb_jawaban?>" hidden>
                                    <input type="text" name="tb_jawaban_isi_old" value="" hidden>

                                    <div class="form-group">
                                        <input type="text" maxlength="150" id="judul" name="tb_jawaban_judul" class="form-control text-white" placeholder="Judul">
                                    </div>
            ...
            <div class="col-12 col-md-5 col-lg-4 mt-4">
                <div class="sidebar-area">
                    ...
                    <div class="single-widget latest-video-widget mb-50">
                        ...
                        <div class="single-post-area mb-30" id="answer-ready-old">
...
<script type="text/javascript">
        ...
        if(data != ''){
            ...
            if((((page+4)/4) == (dataPage) || dataLength == dataMod) && dataMod != 0){
                for(let i = page; i <= ((page+dataMod)-1); i++){
                    ...
                    if(<?=json_encode($id_tb_penjawab)?> == data[i].id_tb_penjawab){
                        if(dataLength == 1){
                            row =   '<div class="single-post-area mb-30">'+
                                        '<div class="row align-items-center">'+
                                            '<div class="col-12 col-lg-12">'+
                                                '<h5 class="text-center text-default">Tidak ada jawaban yang siap di publis.</h5>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>';
    ...
    function validateForm() {     
        let judul = $.trim(document.forms["form-publish"]["tb_jawaban_judul"].value);
       
        if (judul == '' || judul == null) {
            document.forms["form-publish"]["tb_jawaban_judul"].focus();
