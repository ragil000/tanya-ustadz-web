            ...
            <div class="col-12 col-md-7 col-lg-8">
                <div class="all-posts-area">
                    ...
                    <div class="section-heading style-2 mt-4">
                        <h4>Semua Data Akun Nonaktif</h4>
                        <div class="line"></div>
                    </div>
                    ...
                    let row =   '<div class="single-post-area mb-30">'+
                                    '<div class="row align-items-center">'+
                                        ...
                                        '<div class="col-12 col-lg-12 bg-darkself shadow">'+
                                            '<div class="mt-4">'+
                                                '<a href="<?=base_url()?>super/aktifkan-akun/'+data[i].id_tb_akun+'" class="post-cata cata-sm cata-success ml-2 edit-akun">Aktifkan</a>'+
                                            '</div>'+
                                            ...
                                            '<div class="row">'+
                                                '<div class="container mb-3 pt-0 pb-0">'+
                                                    '<p class="post-cata cata-sm cata-danger mb-0 right">Nonaktif</p>'+
                                                '</div>'+
                                            '</div>'+
                                        '</div>'+
